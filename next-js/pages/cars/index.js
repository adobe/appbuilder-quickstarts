    ...
    return (
        <div className="text-center">
            ...
            <ul className="flex justify-center mt-5">
                {cars.map((car) => (
                    <Link key={car.id} className="no-underline text-black visited:text-black" href={`${process.env.PATH_PREFIX}/cars/${car.id}`}>
                        <div className="cursor-pointer">
                            <div className="m-8 max-w-xs rounded overflow-hidden shadow-lg">
                                <Image unoptimized={true} src={car.image} alt={'Next.js middleware'} width={2048} height={2048} layout={"responsive"} />
